...
<head>
    ...
    <title>اعتبار سنجی شماره تلفن</title>
...
<body style="font-family: tahoma"
    class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid"
                                    src="../../../app-assets/images/illustration/verify-email-illustration.svg"
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bolder mb-1">Verify your Phone Numer &#x2709;&#xFE0F;</h2>
                                <p class="card-text mb-2">یک کد به شماره تلفن ثبت شده ی شما ارسال شد لطفا آن را در کادر
                                    زیر وارد کنید</p>

                                <br>

                                <form action="checkCodeForSMSVerify" method="POST">
                                    @csrf
                                    <input type="text" class="form-control @error('code') is-invalid @enderror  "
                                        name="code" placeholder="کد ارسال شده را اینجا وارد کنید">
                                    @error('code')
                                ...
                                <p class="text-center mt-2"><span>Didn&apos;t receive an Phone Numer?</span><a
                                        href="/sendSms"><span>&nbsp;Resend</span></a></p>
                            </div>
                        </div>
                        <!-- verify email-->
                    </div>
