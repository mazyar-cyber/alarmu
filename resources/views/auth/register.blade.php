...
<body style="font-family: tahoma" class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" method="POST"
                                    ...
                                    @csrf
                                    <div class="mb-1">
                                        <label class="form-label" for="register-username">PhoneNumber</label>
                                        <input class="form-control @error('phoneNumber') is-invalid @enderror"
                                            id="register-username" type="number" name="phoneNumber" required
                                            placeholder="09185850000" aria-describedby="register-username"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control  @error('name') is-invalid @enderror"
                                            id="register" type="text" name="name"value="{{ old('name') }}"
                                            required autocomplete="name" placeholder="reza" tabindex="2" />
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input
                                                ...
                                                aria-describedby="password" tabindex="3" /><span
