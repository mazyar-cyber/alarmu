                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-login-form mt-2"  method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control @error('phoneNumber') is-invalid @enderror"
                                            id="login-email" type="number" name="phoneNumber" required
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge  " name="password"
                                                id="login-password" @error('password') is-invalid @enderror
                                    ...
                                    <div class="mb-1">
                                        <div class="form-check">
                                            <input class="form-check-input" id="remember-me" name="remember"
                                                id="remember" {{ old('remember') ? 'checked' : '' }} type="checkbox"
                                                tabindex="3" />
                                ...
                                <p class="text-center mt-2"><span>New on our platform?</span><a
                                        href="/register"><span>&nbsp;Create an account</span></a></p>
